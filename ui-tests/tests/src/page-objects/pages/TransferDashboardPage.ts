...
export const TransferDashboardPage = {
  ...
  downloadErrorsButton: Selector('div.transfers__errors__section')
    .nth(1)
    .child('button')
    .withAttribute('label', 'Download Errors'), // Selector('.transfers__errors__download__button'),
  ...
  findATransferModal: () =>
    Selector('.el-modal__header-title')
  ...
  findATransferModalTransferDownloadTransfersButton: Selector('.mb-input').withText(
    'Download Transfers'
  ),
  ...
  transferDetailsModalTechnicalDetailsTab: Selector('.el-tabs__tab-item').withText(
    'Technical Details'
  ),
  ...
  transferResults: Selector(
    '.el-modal__body .el-scrollbox__content .el-datalist__rows .el-datalist__row'
  ),
  ...
  closeTransferDetailsButton: Selector('#transferDetails span.input-button__label').withText(
    'Close'
  ),
  ...
  closeTechDetailsButtonPopupButton: Selector(
    '#transferRequestDetailsModal span.input-button__label'
  ).withText('Close'),

  //Extension List Objects
  partyExtensionListButton: Selector('span.input-button__label').withText('View Extension List'),
  partyDisabledExtensionListButton: Selector('button').withAttribute(
    'disabled label',
    'View Extension List'
  ),
  ...
  closePartyWithExtensionList: Selector('#partydetailsmodal span.input-button__label').withText(
    'Close'
  ),
  ...
  transferDetailsModalTechnicalDetailsRecipientDetailsField: Selector(
    '#transfer-details-basic-modal__recipient-details'
  ),
  transferDetailsModalTechnicalDetailsDirection: Selector(
    '#transfer-details-basic-modal__direction'
  ),

  async getTransferRowById(innerText: string): Promise<Selector> {
    return Selector('.transfers__transfers__list .el-datalist__row').withText(
      innerText.substring(0, 22)
    );
  },
  ...
  async getTransferByAmount(innerText: string): Promise<Selector> {
    return Selector('.transfers__transfers__list .el-datalist__item-cell')
      .child('div')
      .withText(innerText);
  },
