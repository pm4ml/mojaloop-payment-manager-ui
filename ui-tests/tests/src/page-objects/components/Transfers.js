...
class Transfers {
  constructor() {
    ...
    this.backtoFilteringSubmitButton = Selector('span.input-button__label').withText(
      'Back to filtering'
    );
    this.transferIdList = Selector('span.el-datalist__link__content');

    //Find a transfer batch results page objects
    this.transferResults = Selector(
    ...
    this.partyLookupResponseButton = Selector('span.input-button__label').withText(
    ...
    this.partyExtensionListButton = Selector('span.input-button__label').withText(
      'View Extension List'
    );
    this.partyDisabledExtensionListButton = Selector('button').withAttribute(
      'disabled label',
      'View Extension List'
    );
    ...
    this.qrpayerpartyIdentifierValue = Selector('span')
      .withText('"partyIdentifier"')
      .nextSibling(0);
    ...
    this.qrpayeepartyIdentifierValue = Selector('span')
      .withText('"partyIdentifier"')
      .nth(1)
      .nextSibling(0);
